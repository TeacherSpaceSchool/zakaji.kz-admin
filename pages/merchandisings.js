...
const Merchandisings = React.memo((props) => {
    ...
    return (
        <App cityShow checkPagination={checkPagination} pageName='Мерчендайзинг'>
            <Head>
                ...
                <meta property="og:url" content={`${urlMain}/merchandisings`} />
                <link rel='canonical' href={`${urlMain}/merchandisings`}/>
            </Head>
            <div className='count'>
            ...
            <div className={classes.page}>
                {
                    profile.role==='admin'?
                        <Link href='/merchandisings/[id]' as='/merchandisings/super'>
                            <a>
                        ...
                        if(idx<pagination)
                            return(
                                <LazyLoad scrollContainer={'.App-body'} key={element._id} height={height} offset={[height, 0]} debounce={0} once={true}  placeholder={<CardOrganizationPlaceholder height={height}/>}>
                                    <Link href='/merchandisings/[id]' as={`/merchandisings/${element._id}`}>
                                        <a>
