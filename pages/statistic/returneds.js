    ...
    return (
        <App cityShow pageName='Статистика возвратов'>
            <Head>
                ...
                <meta property='og:title' content='Статистика возвратов' />
                <meta property='og:description' content='' />
                <meta property='og:type' content='website' />
                <meta property='og:image' content={`${urlMain}/static/512x512.png`} />
                <meta property='og:url' content={`${urlMain}/statistic/returneds`} />
                <link rel='canonical' href={`${urlMain}/statistic/returneds`}/>
            </Head>
            ...
            <div className='count' onClick={()=>setShowStat(!showStat)}>
                {
                    statisticReturned?
                        ...
                        <div className={classes.rowStatic}>{`${organization?'Районов':'Компаний'}: ${statisticReturned.row[0].data[0]}`}</div>
                        {
                            showStat?
                                <>
                                <div className={classes.rowStatic}>{`Сумма: ${statisticReturned.row[0].data[1]} тенге`}</div>
